...
if __name__ == '__main__': 
    ...
    galaxyzoo_dir = "~Koketso\\Documents\\Scripts\\data\\galaxy_zoo_zip"
    ...
    galaxyzooq_dir = "~Koketso\\Documents\\Scripts\\data\\resized\\galaxy_zoo_class"



    #Training arguments
    model_name = "Resnet18_final_All"
    patience = 5
    l_r = 1e-4
    best_loss = 5000000

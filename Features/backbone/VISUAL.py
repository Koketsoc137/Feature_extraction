...
def pmap(dataset,scatter = True):
    pc = pacmap.PaCMAP(n_components=2,verbose = False,n_neighbors=None, MN_ratio=0.5, FP_ratio=2.0)
...
def  umap(dataset,scatter = True,name = "UMAP Distribution"):
    start = time.time()
...
def shade(embedded_dataset,predictions,numof_class = 2,name ="Embedding",save = False,label = True,gz = False):
